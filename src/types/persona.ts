...
export const PERSONA_DESCRIPTIONS: Record<PersonaType, string> = {
  ...
  variable_income_budgeter:
    'Income arrives irregularly with limited cash flow buffer',
  subscription_heavy:
    'Multiple recurring subscriptions consuming significant monthly spending',
  savings_builder:
    'Actively building savings with low credit utilization',
  low_use:
    'Limited banking activity - opportunity to engage with more financial tools',
  steady:
    'Maintaining steady financial patterns without major concerns',
};
